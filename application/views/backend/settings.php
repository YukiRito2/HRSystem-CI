                        ...
                        <div class="table_body">
                            <form action="Add_Settings" id="fileUploadForm" method="post" enctype="multipart/form-data"
                                ...
                                <div class="form-group clearfix">
                                    <label for="" class="col-md-3">Subir logo del sitio</label>
                                    <div class="col-md-9">
                                        ...
                                        <label for="img_url" class="custom-file-upload"><i class="fa fa-camera"
                                                aria-hidden="true"></i> Subir Logo</label>
                                        <input type="file" value="" class="" id="img_url" name="img_url"
                                            aria-describedby="fileHelp">
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <label for="title" class="col-md-3">Título del sitio</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="title"
                                            value="<?php echo $settingsvalue->sitetitle; ?>" id="title"
                                            placeholder="Título..." required minlength="7" maxlength="120">
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                ...
                                <div class="form-group clearfix">
                                    <label for="copyright" class="col-md-3">Derechos de autor</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <label for="currency" class="col-md-3">Símbolo</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <label for="email" class="col-md-3">Correo del sistema</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="email" id="email"
                                            value="<?php echo $settingsvalue->system_email; ?>" placeholder="correo...">
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="address" id="address"
                                            value="<?php echo $settingsvalue->address; ?>" placeholder="dirección...">
                                    </div>
                                </div>
                                <div class="form-group clearfix">
