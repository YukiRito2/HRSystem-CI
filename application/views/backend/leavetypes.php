...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-fighter-jet" style="color:#1976d2"></i> Tipos de Licencia</h3>
        </div>
            ...
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal"
                        data-target="#leavemodel" data-whatever="@getbootstrap" class="text-white"><i class=""
                            aria-hidden="true"></i> Agregar Tipos de Licencia</a></button>
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
                        href="<?php echo base_url(); ?>leave/Application" class="text-white"><i class=""
                            aria-hidden="true"></i> Solicitud de Licencia</a></button>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Lista de Licencias </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="jsgrid-align-center ">
                                            ...
                                            <a onclick="confirm('¿Está seguro de que desea eliminar esto?')"
                                                href="LeavetypeDelet?D=<?php echo $value->type_id; ?>" title="Eliminar"
                                                <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                                                hidden <?php } ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Licencia</h4>
                    ...
                    <form method="post" action="Add_leaves_Type" id="leaveform" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Nombre de la licencia</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control custom-select" data-placeholder="Selecciona una categoría"
        ...
        $(document).ready(function() {
            $(".leavetype").click(function(e) {
                ...
                $.ajax({
                    ...
                    $('#leaveform').find('[name="id"]').val(response.leavetypevalue.type_id)
                        .end();
                    $('#leaveform').find('[name="leavename"]').val(response.leavetypevalue.name)
                        .end();
                    $('#leaveform').find('[name="leaveday"]').val(response.leavetypevalue
                        .leave_day).end();
                    $('#leaveform').find('[name="status"]').val(response.leavetypevalue.status)
                        .end();
                });
            });
        });
