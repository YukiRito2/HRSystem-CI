...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
            <div class="col-12">
                <!--<button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#TypeModal" data-whatever="@getbootstrap" class="text-white TypeModal"><i class="" aria-hidden="true"></i> Agregar Nómina </a></button>-->
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
                        href="<?php echo base_url(); ?>Payroll/Salary_List" class="text-white"><i class=""
                            aria-hidden="true"></i> Volver</a></button>
                <button type="button" class="btn btn-primary print_payslip_btn"><i class="fa fa-print"></i><i class=""
                        aria-hidden="true" onclick="printDiv()"></i> Imprimir</button>
            </div>
        </div>
    </div>
            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-4 col-xs-6 col-sm-6">
                        <img src="<?php echo base_url(); ?>assets/images/hrinv.png"
                    ...
                    <div class="col-md-8 col-xs-6 col-sm-6 text-left payslip_address">
                        ...
                        <p>
                            Teléfono: <?php echo $settingsvalue->contact; ?>, Correo Electrónico:
                            <?php echo $settingsvalue->system_email; ?>
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 text-left">
                        <h5 style="margin-top: 15px;">Recibo de salario para el período de
                            <?php echo $salary_info->month . ' ' . $salary_info->year ?></h5>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                            ...
                            <tbody style="border: 1px solid #ececec;">
                                ...
                                <tr>
                                    <td>Asignación de Transporte</td>
                                ...
                                <!--<tr>
                    <td>Sin Pago( <?php echo $work_h_diff ?> hrs)</td>
                    <td class="text-right"> </td>
                    <td class="text-right"> <?php
                            ...
                            <tfoot class="tfoot-light">
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">
                                        <?php echo $salary_info->total_pay/*round($total_add - $total_did,2)*/; ?> USD
                                    </th>
                                </tr>
                            </tfoot>
                        </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel1">Formulario de Sueldo</h4>
                ...
                <form method="post" action="Add_Salary" id="salaryform" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <select class="form-control custom-select" data-placeholder="Elige una Categoría" tabindex="1" name="typeid" required>
                        ...
                        <div class="form-group">
                            <label class="control-label">Id del Empleado</label>
                        ...
                        <div class="form-group">
                            <label class="control-label">Alquiler de Vivienda</label>
                        ...
                        <h4>Deducciones</h4>
                        <div class="form-group">
                            <label class="control-label">Fondo Providente</label>
    ...
    $(document).ready(function() {
        $(".SalarylistModal").click(function(e) {
            ...
            $.ajax({
                ...
                $('#salaryform').find('[name="medical"]').val(response.salaryvalue.medical)
                .end();
                $('#salaryform').find('[name="houserent"]').val(response.salaryvalue.house_rent)
                    .end();
                $('#salaryform').find('[name="bonus"]').val(response.salaryvalue.bonus).end();
                $('#salaryform').find('[name="provident"]').val(response.salaryvalue
                    .provident_fund).end();
