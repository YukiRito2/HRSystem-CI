    ...
    <div class="container-fluid">
        ...
        <div class="row m-b-10">
            <div class="col-12">
                ...
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="#" class="text-white"
                        data-toggle="modal" data-target="#Bulkmodal"><i class="" aria-hidden="true"></i> Agregar
                        Asistencia Masiva</a></button>
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="jsgrid-align-center">
                                            ...
                                            <a href="Save_Attendance?A=<?php echo $value->id; ?>" title="Editar"
                                                class="btn btn-sm btn-danger waves-effect waves-light"
                                                data-value="Approve">Salida</a><br>
                                            <?php } ?>
                                            <a href="Save_Attendance?A=<?php echo $value->id; ?>" title="Editar"
                                                class="btn btn-sm btn-primary waves-effect waves-light"
                                                data-value="Approve"><i class="fa fa-pencil-square-o"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
