...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-map-o"></i> Lista de Soporte Logístico</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                <li class="breadcrumb-item active"><i class="fa fa-bars" aria-hidden="true"></i> Lista Logística</li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Lista Logística</h4>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="jsgrid-align-center ">
                                            ...
                                            <a href="<?php echo base_url(); ?>projects/AssetsDelet?D=<?php echo $value->id; ?>"
                                                onclick="confirm('¿Estás seguro?')" title="Eliminar"
        ...
        <div class="modal fade" id="assetsmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>projects/Add_Assets" id="btnSubmit"
                        enctype="multipart/form-data">
                        <div class="modal-body">

                            <div class="form-group">
                                <label class="control-label">Nombre del Activo</label>
                                <input type="text" name="assetstitle" class="form-control" id="recipient-name1"
                                    required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="date" class="form-control mydatepicker"
                                    id="recipient-name1 datetimepicker2">
                            </div>
                            <div class="form-group">
                                <input name="type" type="checkbox" id="radio_2" data-value="Logistic" class="type"
                                    value="Logistic">
                                <label for="radio_2">Agregar a la Lista de Soporte Logístico</label>
                            </div>
        ...
        $(document).ready(function() {
            $(".assets").click(function(e) {
                ...
                $.ajax({
                    ...
                    $('#btnSubmit').find('[name="assetstitle"]').val(response.assetsByid
                        .assets_name).end();
                    $('#btnSubmit').find('[name="qty"]').val(response.assetsByid.quantity)
                .end();
                    $('#btnSubmit').find('[name="date"]').val(response.assetsByid.entry_date)
                        .end();
                    $('#btnSubmit').find('[name="details"]').val(response.assetsByid
                        .description)
                .end(); // $('#btnSubmit').find('[name="type"]').val(response.assetsByid.Assets_type).end();//
                    if (response.assetsByid.Assets_type == 'Assets')
                        $('#btnSubmit').find(':checkbox[name=type][value="Assets"]').prop(
                            'checked', true);
                    else
                        $('#btnSubmit').find(':radio[name=type][value="Logistic"]').prop(
                            'checked', true);
