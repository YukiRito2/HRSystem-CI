...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-money" aria-hidden="true"></i> Otorgar Préstamo</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                <li class="breadcrumb-item active">Otorgar Préstamo</li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal"
                        data-target="#loanmodel" data-whatever="@getbootstrap" class="text-white"><i class=""
                            aria-hidden="true"></i> Agregar Préstamo </a></button>
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
                        href="<?php echo base_url(); ?>Loan/installment" class="text-white"><i class=""
                            aria-hidden="true"></i> Cuota del Préstamo</a></button>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Lista de Préstamos
                        </h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="jsgrid-align-center ">
                                            <a href="#" title="Editar"
                                                class="btn btn-sm btn-primary waves-effect waves-light loanmodalclass"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel1">Préstamo</h4>
                ...
                <form role="form" method="post" action="Add_Loan" id="btnSubmit" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <select class="form-control custom-select col-md-8" data-placeholder="Elegir un Empleado"
                        ...
                        <div class="form-group row">
                            <label for="message-text" class="control-label col-md-3">Monto</label>
                            <input type="text" name="amount" value="" class="form-control col-md-8 amount"
                                id="recipient-name1" required>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3">Fecha de Aprobación</label>
                            <input type="text" name="appdate" class="form-control col-md-8 mydatetimepickerFull"
                                id="recipient-name1" value="" required>
                        </div>
                        <div class="form-group row">
                            <label for="message-text" class="control-label col-md-3">Periodo de Cuota</label>
                            <input type="number" name="install" value="" class="form-control col-md-8 period"
                                id="recipient-name1" required>
                        </div>
                        <div class="form-group row">
                            <label for="message-text" class="control-label col-md-3">Monto de la Cuota</label>
                            <input type="number" name="installment" value="" class="form-control col-md-8 installment"
                                id="recipient-name1" readonly>
                        </div>
                        <div class="form-group row">
                            <label for="message-text" class="control-label col-md-3"> Número de Préstamo</label>
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control custom-select col-md-8" data-placeholder="Elegir Estado"
                                tabindex="1" name="status" value="" required>
                                <option value="">Seleccionar aquí</option>
                        ...
                        <div class="form-group row">
                            <label for="message-text" class="control-label col-md-3">Detalles del Préstamo</label>
    ...
    $(document).ready(function() {
        $(".loanmodalclass").click(function(e) {
            ...
            $.ajax({
                ...
                $('#btnSubmit').find('[name="details"]').val(response.loanvalue.loan_details)
                    .end();
                $('#btnSubmit').find('[name="appdate"]').val(response.loanvalue.approve_date)
                    .end();
                $('#btnSubmit').find('[name="redate"]').val(response.loanvalue.repayment_from)
                    .end();
                ...
                $('#btnSubmit').find('[name="install"]').val(response.loanvalue.install_period)
                    .end();
                $('#btnSubmit').find('[name="installment"]').val(response.loanvalue.installment)
                    .end();
                $('#btnSubmit').find('[name="loanno"]').val(response.loanvalue.loan_number)
                .end();
