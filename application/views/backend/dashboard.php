                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0">
                                    ...
                                    ?> Empleados</h3>
                                <a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0">Ver
                                    Detalles</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                ...
                                <a href="<?php echo base_url(); ?>Projects/All_Projects" class="text-muted m-b-0">Ver
                                    Detalles</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Proyecto/s en Curso</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered table-hover earning-box">
                                ...
                                <tbody>
                                    ...
                                    <tr style="vertical-align:top;">
                                        <td><a
                                                href="<?php echo base_url(); ?>Projects/view?P=<?php echo base64_encode($value->id); ?>"><?php echo substr("$value->pro_name", 0, 25) . '...'; ?></a>
                                        </td>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Lista de tus próximas tareas a completar</h6>
                            ...
                            <form method="post" action="add_todo" enctype="multipart/form-data" id="add_todo">
                                <div class="input-group">
                                    <input type="text" name="todo_data" class="form-control"
                                        style="border: 1px solid #fff !IMPORTANT;" placeholder="Ingresa nueva tarea...">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Tablero de Avisos</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr class="scrollbar" style="vertical-align:top">
                                        ...
                                        <td><mark><a href="<?php echo base_url(); ?>assets/images/notice/<?php echo $value->file_url ?>"
                                                    target="_blank"><?php echo $value->file_url ?></a></mark></td>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Días Festivos</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive" style="height:600px;overflow-y:scroll">
                            <table class="table table-hover table-bordered earning-box">
