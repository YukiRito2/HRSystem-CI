                                        ...
                                        <div class="col-md-8">
                                            <form class="row" action="Update" method="post"
                                                ...
                                                <div class="form-group col-md-12 m-t-10">
                                                    ...
                                                    <input type="file"
                                                        <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                                                        readonly <?php } ?> class="form-control" name="file"
                                    ...
                                    <form class="row" action="Add_bank_info" method="post"
                                        ...
                                        <div class="form-group col-md-6 m-t-5">
                                            ...
                                            <input type="text" name="bank_name"
                                                ...
                                                class="form-control form-control-line" placeholder="Nombre del Banco"
                                ...
                                <form class="row" action="Add_File" method="post" enctype="multipart/form-data">
                                    <div class="form-group col-md-6 m-t-5">
                                        ...
                                        <input type="text" name="title"
                                            ...
                                            <?php } ?> class="form-control" required="" aria-invalid="false"
                                            minlength="5" required>
                                    </div>
                                    <div class="form-group col-md-6 m-t-5">
                                        ...
                                        <input type="file" name="file_url"
                                            <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly
                                            <?php } ?> class="form-control" required="" aria-invalid="false" required>
                                    </div>
                                    <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                                    <?php } else { ?>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <select
                                                    ...
                                                    data-placeholder="Elige una categoría" tabindex="1" name="typeid"
                                                    required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <input type="text" name="houserent"
                                                    <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                                                    readonly <?php } ?> class="form-control form-control-line houserent"
                                            ...
                                            <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <input type="text" name="medical"
                                                    <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                                                    readonly <?php } ?> class="form-control form-control-line medical"
                                                    placeholder="Salud..."
            ...
            $(".education").click(function(e) {
                ...
                $.ajax({
                    ...
                    $('#educationmodal').find('[name="name"]').val(response.educationvalue
                        .edu_type).end();
                    $('#educationmodal').find('[name="institute"]').val(response.educationvalue
                        .institute).end();
                    $('#educationmodal').find('[name="result"]').val(response.educationvalue
                        .result).end();
                    $('#educationmodal').find('[name="year"]').val(response.educationvalue.year)
                        .end();
        ...
        $(document).ready(function() {
            $(".experience").click(function(e) {
                ...
                $.ajax({
                    ...
                    $('#experiencemodal').find('[name="company_name"]').val(response.expvalue
                        .exp_company).end();
                    $('#experiencemodal').find('[name="position_name"]').val(response.expvalue
                        .exp_com_position).end();
                    $('#experiencemodal').find('[name="address"]').val(response.expvalue
                        .exp_com_address).end();
                    $('#experiencemodal').find('[name="work_duration"]').val(response.expvalue
                        .exp_workduration).end();
                    $('#experiencemodal').find('[name="emid"]').val(response.expvalue.emp_id)
                        .end();
                });
            });
        });
