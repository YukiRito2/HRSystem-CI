        ...
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal"
                        data-target="#TypeModal" data-whatever="@getbootstrap" class="text-white TypeModal"><i class=""
                            aria-hidden="true"></i> Agregar Tipo de Salario </a></button>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="jsgrid-align-center ">
                                            <a href="" title="Editar"
                                                class="btn btn-sm btn-primary waves-effect waves-light TypeModal"
                    ...
                    <form method="post" action="Add_Sallary_Type" id="typeform" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="typename" class="form-control" id="recipient-name1"
        ...
        $(document).ready(function() {
            $(".TypeModal").click(function(e) {
                ...
                $.ajax({
                    ...
                    $('#typeform').find('[name="typename"]').val(response.typevalueid
                        .salary_type).end();
                    $('#typeform').find('[name="createdate"]').val(response.typevalueid
                        .create_date).end();
                });
            });
        });
