            ...
            <div class="col-12">
                ...
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
                        href="<?php echo base_url(); ?>Payroll/Generate_salary" class="text-white"><i class=""
                            aria-hidden="true"></i> Generar Nómina</a></button>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Lista de
                            Nóminas
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example123" class="display nowrap table table-hover table-striped table-bordered"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $individual_info->first_name . ' ' . $individual_info->last_name; ?>
                                        </td>
                                        ...
                                        <td class="jsgrid-align-center ">
                                            <a href="<?php echo base_url(); ?>payroll/invoice?Id=<?php echo $individual_info->pay_id; ?>&em=<?php echo $individual_info->emp_id; ?>"
                                                title="Editar" class="btn btn-sm btn-danger waves-effect waves-light"><i
                ...
                <div class="modal-content ">
                    ...
                    <form method="post" action="Add_Salary" id="salaryform" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <h4>Deducción</h4>
                            <div class="form-group">
                                <label class="control-label">Fondo de Previsión</label>
...
$(document).ready(function() {
    $(".SalarylistModal").click(function(e) {
        ...
        $.ajax({
            ...
            $('#salaryform').find('[name="provident"]').val(response.salaryvalue.provident_fund)
                .end();
