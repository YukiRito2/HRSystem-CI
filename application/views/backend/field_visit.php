...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-briefcase"></i> Aplicación
            </h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Aplicación de Autorización de Campo
                </li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info">
                    ...
                    <a data-toggle="modal" data-target="#appmodel" data-whatever="@getbootstrap" class="text-white"
                        id="addNewApplication">
                        <i class="" aria-hidden="true"></i> Agregar Aplicación
                    </a>
                </button>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Lista de Aplicaciones
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="myTable" class="display nowrap table table-hover table-striped table-bordered"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Ubicación</th>
                                        <th>PIN del Empleado</th>
                                        <th>Nombre del Empleado</th>
                                        <th>Fecha de Inicio</th>
                                        <th>Fecha Aproximada de Fin</th>
                                        <th>Días Totales</th>
                                        <th>Fecha Real de Retorno</th>
                                        <th>Estado</th>
                                        <th>Acción</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr style="vertical-align:top">
                                        ...
                                        <td class="jsgrid-align-center">
                                            ...
                                            <?php } elseif ($value->status == 'No Aprobado') { ?>

                                            <a href="" title="Editar"
                                                class="btn btn-sm btn-info waves-effect waves-light Status "
                                                data-id="<?php echo $value->id; ?>" data-value="Aprobado"
                                                data-duration="<?php echo $value->total_days; ?>">Aprobar
                                            </a>
                                            <br>

                                            <a href="" title="Editar"
                                                class="btn btn-sm btn-info waves-effect waves-light  Status"
                                                data-id="<?php echo $value->id; ?>" data-value="Rechazado">Rechazar
                                            </a>
                                            <br>
                                            ...
                                            <a href="" title="Editar"
                                                class="btn btn-sm btn-primary waves-effect waves-light fieldAuthEdit"
                                                data-id="<?php echo $value->id; ?>">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </a>

                                            <?php if ($value->attendance_updated !== 'done' and $value->status == 'Aprobado'): ?>
                                            <a href="" id="closeAndUpdateFieldVisit"
                                                data-confirm="¿Está seguro de que desea cerrar su visita al campo y actualizar la asistencia?"
                                                title="Marcar como hecho"
                                                class="btn btn-sm btn-info waves-effect waves-light"
                                                data-id="<?php echo $value->id; ?>"
                                                data-employeeID="<?php echo $value->em_code; ?>">
                                                <i class="fa fa-scissors"></i> Actualizar asistencia
                                            </a>
                                            <?php endif; ?>
                                        </td>
                                        <?php } ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul>
                    <li>Cuando edites los formularios aplicados desde el botón de edición, no olvides reautorizar
                        aprobando la información.</li>
                    <li>Una vez que des la aprobación final y confirmes el cierre final, la asistencia se actualizará
                        permanentemente.</li>
                </ul>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content ">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Autorización de Campo
                        </h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 custom-select emid" tabindex="1"
                                            name="projectID" style="width:100%" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 custom-select emid" tabindex="1" name="emid"
                                    ...
                                    <div class="form-group">
                                        <label for="fieldLocation" class="control-label">Ubicación del Campo</label>
                                        <input type="text" class="form-control" placeholder="Ubicación del campo"
                                            name="fieldLocation">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Fecha de Inicio Aproximada</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="returnDate">
                                        <label class="control-label">Fecha Real de Regreso
                                        </label>
        ...
        $(document).ready(function() {
            $(".fieldAuthEdit").click(function(e) {
                ...
                $.ajax({
                    ...
                    $('#fieldAuthForm').find('[name="projectID"]').val(response.project_id)
                    .end();
                    $('#fieldAuthForm').find('[name="emid"]').val(response.emp_id).end();
                    $('#fieldAuthForm').find('[name="fieldLocation"]').val(response
                        .field_location).end();
                    $('#fieldAuthForm').find('[name="startdate"]').val(response.start_date)
                    .end();
                    $('#fieldAuthForm').find('[name="enddate"]').val(response.approx_end_date)
                        .end();
                    ...
                    $('#fieldAuthForm').find('[name="actualReturnDate"]').val(response
        ...
        $(document).ready(function() {
            $(".leaveapp").click(function(e) {
                ...
                $.ajax({
                    ...
                    $('#leaveapply').find('[name="duration"]').val(response.leave_duration)
                    .end();
