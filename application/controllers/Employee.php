...
class Employee extends CI_Controller
{
    ...
    public function Save()
    {
        if ($this->session->userdata('user_login_access') != False) {
            ...
            $this->form_validation->set_rules('contact', 'contact', 'trim|required|min_length[5]|max_length[10]|xss_clean');
                ...
                if ($this->employee_model->Does_email_exists($email) && $password != $confirm) {
                    ...
                    if ($_FILES['image_url']['name']) {
                        ...
                        $config = array(
                            ...
                            'overwrite' => False,
                            'max_size' => "202240000", // Can be set to particular file size , here it is 2 MB(2048 Kb)
                            'max_height' => "32800",
                            'max_width' => "32800"
                        );
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($_FILES['image_url']['name']) {
                    ...
                    $config = array(
                        ...
                        'allowed_types' => "gif|jpg|png|jpeg",
                        'overwrite' => False,
                        'max_size' => "202420000", // Can be set to particular file size , here it is 2 MB(2048 Kb)
                        'max_height' => "200000",
                        'max_width' => "200000"
                    );
